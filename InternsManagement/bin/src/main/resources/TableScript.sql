DROP SCHEMA IF EXISTS interns_management_db;

CREATE SCHEMA interns_management_db;
USE interns_management_db;
...
project_name VARCHAR (20) not null,
 ...
 CONSTRAINT pa_project_id_pk PRIMARY KEY (project_id)
